...
class MenuEmergencyRescueTeam : AppCompatActivity(),  ProductListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvMenuEngineeringRecord.apply {
            layoutManager = LinearLayoutManager(this@MenuEmergencyRescueTeam)
    ...
    override fun onProductClicked(product: Product) {
        ...
        {
            "Ventaza Record" ->
            {val intent = Intent (this@MenuEmergencyRescueTeam,VentazaRecordData::class.java)
            startActivity(intent)}
            "AC Record" ->
            {
                val intent = Intent (this@MenuEmergencyRescueTeam,ACRecordData::class.java)
                    startActivity(intent)
            }
        }
